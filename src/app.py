...
activities = {
    ...
    "Art Studio": {
        "description": "Create paintings, drawings, and sculptures with professional instruction",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["nathan@mergington.edu", "sophia@mergington.edu"]
    },
    "Science Club": {
        "description": "Explore experiments, research, and scientific discoveries",
